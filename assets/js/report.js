...
(async () => {
  ...
  const GRADE_GUIDE = [
    ...
    ["作業成績", ["全部準時、內容用心，主動加做或協助同學",
                "準時繳交、完整用心，會主動訂正",
                "大致準時完整，偶爾需要提醒"]],
    // 2026-09-25 起照「課堂量尺」判（班規頁可看整把尺；正本 SPEC_課堂量尺.md §2）
    ["上課參與", ["課堂量尺 +3 以上：帶動小組討論、上台講解讓同學聽懂，或帶全班一起學會",
                "課堂量尺 +2：主動舉手發表、上台做題或回答、分組時主動提出想法",
                "課堂量尺 +1：遵守上課規則、專心聽講、完成指派任務（有課堂負向時往下降一級）"]],
